		...
		<section class="body">
			...
			<!--	<section role="main" class="content-body">
					...
					<header class="page-header">
						<h2>Form Tambah jaringan pada Tempat Duduk</h2>
					</header>
							...
							<form id="form" class="form-horizontal" method="POST">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Form Penginputan Jaringan Tempat Duduk</h2>
										<p class="panel-subtitle">
											Penambahan Jaringan Tempat Duduk yang di perlukan di PT KAI DRIVE III
										</p>
									</header>
									<div class="panel-body">
										...
										<div class="form-group">
											<label class="col-sm-3 control-label">Nama lokasi Tempat Dududk :  <span class="required">*</span></label>
											<div class="col-sm-9">
					...
					<!-- Memasukkan Boarding ke Database -->
						<?php 
							if(isset($_POST["submit"]))
							{
								...
								$nama_td = $_POST["nama"];
								$a=$object->simpandatajaringantd($kode,$nama_td,$lokasi);
	       					...
	       					if($a){
	       						echo '<div id="tampil_modal">
											    <div id="modal_blue">
											      ...
											      <a href="tambah_jaringan_td.php"><button id="oke_blue">Oke</button></a>
											    </div></div>';
	       						...
	       						echo '<div id="tampil_modal">
											    <div id="modal">
											      ...
											      <a href="tambah_jaringan_td.php"><button id="oke">Oke</button></a>
											    </div></div>';	
	       						}
