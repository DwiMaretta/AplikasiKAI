...
$pdf->Cell(3, 0.8, 'Nama Stasiun', 1, 0, 'C');
$pdf->Cell(9, 0.8, 'Lokasi', 1, 0, 'C');
...
$query=mysqli_query($koneksi,"SELECT * from kondisi_cctv_stasiun INNER JOIN cctv_stasiun ON cctv_stasiun.kode = kondisi_cctv_stasiun.kode_cctv where `nama_stasiun`='$nama_stasiun' and tanggal between '$awal' and '$akhir'");
while($lihat=mysqli_fetch_array($query)){
	$pdf->Cell(1, 0.8, $no , 1, 0, 'C');
	$pdf->Cell(3, 0.8, $lihat['kode_cctv'],1, 0, 'C');
	$pdf->Cell(3, 0.8, $lihat['nama_stasiun'],1, 0, 'C');
...
$pdf->Output("laporan_cctv_stasiun.pdf","I");
