...
$kode = $_GET['kode'];
$dataa=$object->edit_cctv_kantor($kode); 
					...
					<div class="row-md-6" >
							...
							<form id="form" class="form-horizontal" method="POST">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Form Ubah Asset CCTV Kantor</h2>
						...
						<?php 
							if(isset($_POST["submit"]))
							{
								$kode = $_POST["kode"];
								$lokasi = $_POST["lokasi"];
								$hasil=$object->simpanubahcctvkantor($kode,$lokasi);



	 					if($hasil)
	    				echo"<script>alert('Data Berhasil Disimpan'); document.location='cctv_kantor.php';</script>";
