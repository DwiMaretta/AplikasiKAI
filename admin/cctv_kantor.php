...
$kantor=$object->tampilkancctvkantor(); 
					...
					<!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">CCTV Kantor</h2>
							</header>
							<div class="panel-body">
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody>
										<?php 
										    $i = 0;
										    WHILE ($row_k = mysqli_fetch_array($kantor)) :
										    ?>
										    <tr>
										    <td>
										    ...
										    <td class="actions">
												...
												<a href="edit_cctv_kantor.php?kode=<?php echo $row_k['kode']; ?>" class="on-default edit-row"><i class="fa fa-pencil"> Ubah</i></a>
												<a href="hapus_cctv_kantor.php?kode=<?php echo $row_k['kode']; ?>" class="on-default remove-row"><i class="fa fa-trash-o"> Hapus</i></a>
											</td>
									...
									<td></td>
									<td></td>
									<td><input type="checkbox" name="allboxbaik" value="check" onclick="checkAll(0);" /> Baik semua ||
									<input type="checkbox" name="allboxrusak" value="check" onclick="checkAll(0);" /> Rusak semua</td>
								</table>
								</div>
								<br>
...
if(isset($_POST["submit"])){
	...
	for($x=0; $x<$i; $x++){
    	...
    	$a=$object->simpanCheckCctvKantor($tanggal,$time,$kode,$kondisi,$user);
		...
		<a href="cctv_kantor.php"><button id="oke_blue">Oke</button></a>
		</div></div>';										
	    }
