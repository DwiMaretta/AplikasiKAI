...
$koneksi=$object->koneksi();
		...
		<form action="laporan_jaringan_loket.php" method="post" name="postform">
			<p align="center"><font color="orange" size="5"><b>Laporan Jaringan Loket</b></font></p><br />
			<table border="0">
				<div class="row">
									<div class="col-sm-6">
										<form method="post">
		...
		<?php
			...
			<script language="JavaScript">
				...
				document.location='laporan_jaringan_loket.php';
			</script>
			<?php
			}else{
			...
			<?php
			$query=mysqli_query($koneksi,"SELECT * from kondisi_jaringan_loket INNER JOIN jaringan_loket ON jaringan_loket.kode = kondisi_jaringan_loket.kode_jaringan where `nama_stasiun`='$nama_stasiun' and  tanggal between '$tanggal_awal' and '$tanggal_akhir'");
			}
		?>
		<br>
		<a style="margin-bottom:10px" href="excel_jaringan_loket.php?awal=<?php echo $_POST['tanggal_awal']?>&akhir=<?php echo $_POST['tanggal_akhir']?>&nama=<?php echo $_POST['nama']?>" target="_blank" class="btn btn-default pull-right"><span class='glyphicon glyphicon-print'></span>  Excel</a>
		<a style="margin-bottom:10px" href="pdf_jaringan_loket.php?awal=<?php echo $_POST['tanggal_awal']?>&akhir=<?php echo $_POST['tanggal_akhir']?>&nama=<?php echo $_POST['nama']?>" target="_blank" class="btn btn-default pull-right"><span class='glyphicon glyphicon-print'></span>  PDF</a>
		</p>
