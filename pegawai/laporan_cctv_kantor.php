...
$koneksi=$object->koneksi();
		...
		<form action="laporan_cctv_kantor.php" method="post" name="postform">
			<p align="center"><font color="orange" size="5"><b>Laporan CCTV Kantor</b></font></p><br />
			<table border="0">
				<tr>
		...
		<?php
			...
			<script language="JavaScript">
				...
				document.location='laporan_cctv_kantor.php';
			</script>
			<?php
			}else{
			...
			<?php
			$query=mysqli_query($koneksi,"select * from kondisi_cctv_kantor INNER JOIN cctv_kantor ON cctv_kantor.kode = kondisi_cctv_kantor.kode_cctv where tanggal between '$tanggal_awal' and '$tanggal_akhir'");
			}
		?>
		<br>
		<a style="margin-bottom:10px" href="excel_cctv_kantor.php?awal=<?php echo $_POST['tanggal_awal']?>&akhir=<?php echo $_POST['tanggal_akhir']?>" target="_blank" class="btn btn-default pull-right"><span class='glyphicon glyphicon-print'></span>  Excel</a>
		<a style="margin-bottom:10px" href="pdf_cctv_kantor_new.php?awal=<?php echo $_POST['tanggal_awal']?>&akhir=<?php echo $_POST['tanggal_akhir']?>" target="_blank" class="btn btn-default pull-right"><span class='glyphicon glyphicon-print'></span>  PDF</a>
		</p>
