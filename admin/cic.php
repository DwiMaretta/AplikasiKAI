					...
					<header class="page-header">
								...
								<div class="row">
									...
									<?php
										    ...
										    if(isset($_POST["kirim_stasiun"])){
												...
												$jaringan_cic=$object->tampilkanjaringancic($nama_stasiun);
												}

												else{
												$jaringan_cic=$object->tampilkanjaringancicsemua();
												}
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Jaringan CIC</h2>
							</header>
							<div class="panel-body">
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody>
										<?php 
										    $i = 0;
										    WHILE ($row_k = mysqli_fetch_array($jaringan_cic)) :
										    ?>
										    <tr>
										    <td>
										    ...
										    <td class="actions">
												...
												<a href="edit_jaringan_cic.php?kode=<?php echo $row_k['kode']; ?>" class="on-default edit-row"><i class="fa fa-pencil">Ubah</i></a> 
												<a href="hapus_jaringan_cic.php?kode=<?php echo $row_k['kode']; ?>" class="on-default remove-row"><i class="fa fa-trash-o">Hapus</i></a>
											</td>
...
if(isset($_POST["submit"])){
	...
	for($x=0; $x<$i; $x++){
    	...
    	$a=$object->simpanCheckJaringanCIC($tanggal,$time,$kode,$kondisi,$user);
		...
		<a href="cic.php"><button id="oke_blue">Oke</button></a>
		</div></div>';										
	    }
