...
$datanya=$object->tampilkanlocotrackCC201();
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Locotrack CC201</span></li>
							</ol>
					...
					<!--aaaaaa-->
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Locotrack CC201</h2>
							</header>
							<div class="panel-body">
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody>
										<?php 
										    $i = 0;
										    WHILE ($row_k = mysqli_fetch_array($datanya)) :
										    ?>
										    <tr>
										    <td><center>
									...
									<td></td>
									<td><center><input type="checkbox" name="allboxbaik" value="check" onclick="checkAll(0);" /> Baik semua  || 
										<input type="checkbox" name="allboxrusak" value="check" onclick="checkAll(0);" /> Rusak semua</td></center>
									<td></td>
								</table>
								</div>
								<br>
...
if(isset($_POST["submit"])){
	...
	for($x=0; $x<$i; $x++){
	    ...
	    $tanggal = date('Ymd');
	    $kode=$_POST['code'][$x];
	    $jenis_locotrack="CC201";
	    $kondisi=$_POST['cek'][$x];
	    $user=$_COOKIE['nama'];

    	$a=$object->simpanCheckLocotrack($tanggal,$time,$kode,$jenis_locotrack,$kondisi,$user);
		...
		<a href="locotrack_CC201.php"><button id="oke_blue">Oke</button></a>
		</div></div>';										
	    }
	    else{
