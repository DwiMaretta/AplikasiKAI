							...
							<form id="form" class="form-horizontal" method="POST">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Form Penginputan CCTV Stasiun</h2>
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" class="form-control" placeholder="Lokasi cctv" required name="lokasi"/>
											</div>
											<div class="col-sm-9">
											</div>
										</div>	
					...
					<!-- Memasukkan Asset ke Database -->
						<?php 
							if(isset($_POST["submit"]))
							{
								...
								$a=$object->simpandatacctvstasiun($kode,$nama_stasiun,$lokasi);
	       						...
	       						echo '<div id="tampil_modal">
											    <div id="modal_blue">
											      ...
											      <a href="tambah_cctv_stasiun.php"><button id="oke_blue">Oke</button></a>
											    </div></div>';
	       						...
	       						echo '<div id="tampil_modal">
											    <div id="modal">
											      ...
											      <a href="tambah_cctv_stasiun.php"><button id="oke">Oke</button></a>
											    </div></div>';	
	       						}
