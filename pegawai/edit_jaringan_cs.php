...
$kode = $_GET['kode'];
$dataa=$object->edit_jaringan_cs($kode); 
					...
					<div class="row-md-6" >
							...
							<form id="form" class="form-horizontal" method="POST">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Form Ubah Asset Customer Service Jaringan</h2>
									...
									<div class="panel-body">
										...
										<div class="form-group">
											<label class="col-sm-3 control-label">Nama Jaringan CS:  <span class="required">*</span></label>
											<div class="col-sm-9">
												<input type="text" class="form-control" required name="nama" value="<?php echo $nama_cs; ?>"/>
											</div>
										</div>	
						...
						<?php 
							if(isset($_POST["submit"]))
							{
								...
								$hasil=$object->simpanubahjaringancs($kode,$nama_cs,$nama_stasiun);



	 					if($hasil)
	    				echo"<script>alert('Data Berhasil Disimpan'); document.location='cs.php';</script>";
