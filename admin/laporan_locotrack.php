...
$koneksi=$object->koneksi();
		...
		<form action="laporan_locotrack.php" method="post" name="postform">
			<p align="center"><font color="orange" size="5"><b>Laporan Kondisi Locotrack</b></font></p><br />
			<table border="0">
				<div class="row">
									<div class="col-sm-6">
										<form method="post">
										<div class="col-sm-12">
											  <label for=""><h4><b>Locotrack : </b></h4></label>
		...
		<?php
			...
			<script language="JavaScript">
				...
				document.location='laporan_locotrack.php';
			</script>
			<?php
			}else{
			...
			<?php
			$query=mysqli_query($koneksi,"SELECT * from kondisi_locotrack INNER JOIN locotrack ON locotrack.kode = kondisi_locotrack.kode_locotrack where `jenis_locotrack`='$nama_locotrack' and tanggal between '$tanggal_awal' and '$tanggal_akhir'");
			}
		?>
		<br>
		<a style="margin-bottom:10px" href="excel_locotrack.php?awal=<?php echo $_POST['tanggal_awal']?>&akhir=<?php echo $_POST['tanggal_akhir']?>&nama=<?php echo $_POST['nama']?>" target="_blank" class="btn btn-default pull-right"><span class='glyphicon glyphicon-print'></span>  Excel</a>
		<a style="margin-bottom:10px" href="pdf_locotrack.php?awal=<?php echo $_POST['tanggal_awal']?>&akhir=<?php echo $_POST['tanggal_akhir']?>&nama=<?php echo $_POST['nama']?>" target="_blank" class="btn btn-default pull-right"><span class='glyphicon glyphicon-print'></span>  PDF</a>
		</p>
		<table class="table table-bordered table-striped mb-none" id="datatable-editable">
			<tr bgcolor="#FF6600">
				<th>Kode Locotrack</th>
				<th>Jenis Locotrack</th>
				<th>Tanggal</th>
				<th>Jam</th>
				<th>Kondisi</th>
				<th>Pemeriksa</th>	     
			...
			?>
			<tr>
				<td><?php echo $row['kode_locotrack'];?></td>
				<td><?php echo $row['jenis_locotrack'];?></td>
