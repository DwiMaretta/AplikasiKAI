...
$koneksi=$object->koneksi();
		...
		<form action="laporan_jaringan_boarding_new.php" method="post" name="postform">
		...
		<?php
			...
			<script language="JavaScript">
				...
				document.location='laporan_jaringan_boarding_new.php';
			</script>
			<?php
			}else{
		...
		<a style="margin-bottom:10px" href="pdf_cctv_stasiun_new.php?awal=<?php echo $_POST['tanggal_awal']?>&akhir=<?php echo $_POST['tanggal_akhir']?>&nama=<?php echo $_POST['nama']?>" target="_blank" class="btn btn-default pull-right"><span class='glyphicon glyphicon-print'></span>  PDF</a>
		</p>
