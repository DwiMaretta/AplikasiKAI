					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Jaringan Boarding</span></li>
							</ol>
								...
								<div class="row">
									...
									<?php
										    ...
										    if(isset($_POST["kirim_stasiun"])){
												...
												$jaringan_boarding=$object->tampilkanjaringanboarding($nama_stasiun);
												}

												else{
												$jaringan_boarding=$object->tampilkanjaringanboardingsemua();
												}
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Jaringan Boarding</h2>
							</header>
							<div class="panel-body">
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody>
										<?php 
										    $i = 0;
										    WHILE ($row_k = mysqli_fetch_array($jaringan_boarding)) :
										    ?>
										    <tr>
										    <td>
										    ...
										    <td><input type="hidden" name="nama_stasiun[]" value="<?php echo $row_k['nama_stasiun']; ?>"><?php echo $row_k['nama_stasiun']; ?>
										    	<td><?php echo $row_k['nama_boarding']; ?></td>
										    </td>
										    <td>
										    ...
										    <td class="actions">
												...
												<a href="edit_jaringan_boarding.php?kode=<?php echo $row_k['kode']; ?>" class="on-default edit-row"><i class="fa fa-pencil">Ubah</i></a>
												<a href="hapus_boarding_jaringan.php?kode=<?php echo $row_k['kode']; ?>" class="on-default remove-row"><i class="fa fa-trash-o">Hapus</i></a>
											</td>
...
if(isset($_POST["submit"])){
	...
	for($x=0; $x<$i; $x++){
    	...
    	$a=$object->simpanCheckJaringanBoarding($tanggal,$time,$kode,$kondisi,$user);
		...
		<p>Data Check Jaringan Berhasil tersimpan!.</p>
		<a href="boarding.php"><button id="oke_blue">Oke</button></a>
		</div></div>';										
	    }
