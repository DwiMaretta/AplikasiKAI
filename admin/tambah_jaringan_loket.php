							...
							<form id="form" class="form-horizontal" method="POST">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Form Penginputan Jaringan Loket</h2>
										<p class="panel-subtitle">
											Penambahan Loket yang di perlukan di PT KAI DRIVE III
										</p>
									</header>
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" class="form-control" placeholder="eg.: Kode Loket" required name="kode"/>
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label">Nama Loket:  <span class="required">*</span></label>
											<div class="col-sm-9">
												<input type="text" class="form-control" placeholder="eg.: Nama Jaringan" required name="nama"/>
											</div>
											<div class="col-sm-9">
											</div>
										</div>		
					...
					<!-- Memasukkan Loket ke Database -->
						<?php 
							if(isset($_POST["submit"]))
							{
								...
								$a=$object->simpandatajaringanloket($kode,$nama_loket,$lokasi);
	       					...
	       					if($a){
	       						echo '<div id="tampil_modal">
											    <div id="modal_blue">
											      ...
											      <a href="tambah_jaringan_loket.php"><button id="oke_blue">Oke</button></a>
											    </div></div>';
	       						...
	       						echo '<div id="tampil_modal">
											    <div id="modal">
											      ...
											      <a href="tambah_jaringan_loket.php"><button id="oke">Oke</button></a>
											    </div></div>';	
	       						}
