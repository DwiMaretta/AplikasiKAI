...
$koneksi=$object->koneksi();
		...
		<form action="laporan_jaringan_cic.php" method="post" name="postform">
			<p align="center"><font color="orange" size="5"><b>Laporan Jaringan CIC</b></font></p><br />
			<table border="0">
				<div class="row">
									<div class="col-sm-6">
										<form method="post">
		...
		<?php
			...
			<script language="JavaScript">
				...
				document.location='laporan_jaringan_cic.php';
			</script>
			<?php
			}else{
			...
			<?php
			$query=mysqli_query($koneksi,"SELECT * from kondisi_jaringan_cic INNER JOIN jaringan_cic ON jaringan_cic.kode = kondisi_jaringan_cic.kode_jaringan where `nama_stasiun`='$nama_stasiun' and tanggal between '$tanggal_awal' and '$tanggal_akhir'");
			}
		?>
		<br>
		<a style="margin-bottom:10px" href="excel_jaringan_cic.php?awal=<?php echo $_POST['tanggal_awal']?>&akhir=<?php echo $_POST['tanggal_akhir']?>&nama=<?php echo $_POST['nama']?>" target="_blank" class="btn btn-default pull-right"><span class='glyphicon glyphicon-print'></span>  Excel</a>
		<a style="margin-bottom:10px" href="pdf_jaringan_cic_fix.php?awal=<?php echo $_POST['tanggal_awal']?>&akhir=<?php echo $_POST['tanggal_akhir']?>&nama=<?php echo $_POST['nama']?>" target="_blank" class="btn btn-default pull-right"><span class='glyphicon glyphicon-print'></span>  PDF</a>
		</p>
