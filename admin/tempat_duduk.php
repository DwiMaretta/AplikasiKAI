					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Jaringan Tempat Duduk</span></li>
							</ol>
								...
								<div class="row">
									...
									<?php
										    ...
										    if(isset($_POST["kirim_stasiun"])){
												...
												$jaringan_td=$object->tampilkanjaringantd($nama_stasiun);
												}

												else{
												$jaringan_td=$object->tampilkanjaringantdsemua();
												}
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Jaringan Tempat Duduk</h2>
							</header>
							<div class="panel-body">
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody>
										<?php 
										    $i = 0;
										    WHILE ($row_k = mysqli_fetch_array($jaringan_td)) :
										    ?>
										    <tr>
										    <td>
										    ...
										    <td class="actions">
												...
												<a href="edit_jaringan_tempat_duduk.php?kode=<?php echo $row_k['kode']; ?>" class="on-default edit-row"><i class="fa fa-pencil">Ubah</i></a>
												<a href="hapus_jaringan_td.php?kode=<?php echo $row_k['kode']; ?>" class="on-default remove-row"><i class="fa fa-trash-o">Hapus</i></a>
											</td>
...
if(isset($_POST["submit"])){
	...
	for($x=0; $x<$i; $x++){
    	...
    	$a=$object->simpanCheckJaringanTD($tanggal,$time,$kode,$kondisi,$user);
		...
		<p>Data Check Jaringan Telah tersimpan!.</p>
		<a href="tempat_duduk.php"><button id="oke_blue">Oke</button></a>
		</div></div>';										
	    }
