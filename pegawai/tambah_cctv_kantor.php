							...
							<form id="form" class="form-horizontal" method="POST">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Form Penginputan CCTV Kantor</h2>
									...
									<div class="panel-body">
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" class="form-control" placeholder="ex.: Kode CCTV" required name="kode"/>
											</div>
										</div>	
										<div class="form-group">
											<label class="col-sm-3 control-label">Lokasi :  <span class="required">*</span></label>
											<div class="col-sm-9">
												<input type="text" class="form-control" placeholder="ex.: unit a ruang b  " required name="lokasi"/>
											</div>
											<div class="col-sm-9">
											</div>
										</div>	
					...
					<!-- Memasukkan CCTV ke Database -->
						<?php 
							if(isset($_POST["submit"]))
							{
								$kode = $_POST["kode"];
								$lokasi = $_POST["lokasi"];
								$a=$object->simpandatacctvkantor($kode,$lokasi);
	       					...
	       					if($a){
	       						echo '<div id="tampil_modal">
											    <div id="modal_blue">
											      ...
											      <a href="tambah_cctv_kantor.php"><button id="oke_blue">Oke</button></a>
											    </div></div>';
	       						...
	       						echo '<div id="tampil_modal">
											    <div id="modal">
											      ...
											      <a href="tambah_cctv_kantor.php"><button id="oke">Oke</button></a>
											    </div></div>';	
	       						}
