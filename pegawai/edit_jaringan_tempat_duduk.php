...
$kode = $_GET['kode'];
$dataa=$object->edit_jaringan_td($kode); 

    foreach ($dataa as $data) {

    $nama_cic=$data['nama_td'];
					...
					<div class="row-md-6" >
							...
							<form id="form" class="form-horizontal" method="POST">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Form Ubah Asset Jaringan Tempat Duudk</h2>
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" class="form-control" required name="nama" value="<?php echo $nama_cic; ?>"/>
											</div>
										</div>	
						...
						<?php 
							if(isset($_POST["submit"]))
							{
								...
								$hasil=$object->simpanubahjaringantd($kode,$nama_td,$nama_stasiun);



	 					if($hasil)
	    				echo"<script>alert('Data Berhasil Disimpan'); document.location='tempat_duduk.php';</script>";
