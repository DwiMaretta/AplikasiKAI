...
$kode = $_GET['kode'];
$dataa=$object->edit_jaringan_cic($kode); 

    foreach ($dataa as $data) {

    $nama_cic=$data['nama_cic'];
					...
					<div class="row-md-6" >
							...
							<form id="form" class="form-horizontal" method="POST">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Form Ubah Asset Jaringan CIC</h2>
						...
						<?php 
							if(isset($_POST["submit"]))
							{
								...
								$hasil=$object->simpanubahjaringancic($kode,$nama_cic,$nama_stasiun);



	 					if($hasil)
	    				echo"<script>alert('Data Berhasil Disimpan'); document.location='cic.php';</script>";
