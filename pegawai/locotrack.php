					...
					<!--aaaaaa-->
								<div class="row">
									<div class="col-sm-6">
										...
										<?php
												...
												$datalocotrack=$object->tampilkanlocotrack($locotrack);
												}

												else{
												$datalocotrack=$object->tampilkanlocotracksemua();
												}
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Locotrack</h2>
							</header>
							<div class="panel-body">
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody>
										<?php 
										    $i = 0;
										    WHILE ($row_k = mysqli_fetch_array($datalocotrack)) :
										    ?>
										    <tr>
										    <td><center>
										    	
										    	<input type="hidden" name="jenis[]" value="<?php echo $row_k['jenis_locotrack']; ?>"><?php echo $row_k['jenis_locotrack']; ?>
										    </center></td>
										    <td><center>
										    ...
										    <td class="actions"><center>
												...
												<a href="edit_locotrack.php?kode=<?php echo $row_k['kode']; ?>" class="on-default edit-row"><i class="fa fa-pencil"></i> Ubah</a>
												<a href="hapus_locotrack.php?kode=<?php echo $row_k['kode']; ?>" class="on-default remove-row"><i class="fa fa-trash-o"> Hapus</i></a>
											</center></td>
									...
									<td></td>
									<td></td>
									<td><center><input type="checkbox" name="allboxbaik" value="check" onclick="checkAll(1);" /> Baik semua  || 
										<input type="checkbox" name="allboxrusak" value="check" onclick="checkAll(1);" /> Rusak semua</td></center>
									<td></td>
								</table>
								</div>
								<br>
...
if(isset($_POST["submit"])){
	...
	for($x=0; $x<$i; $x++){
	    ...
	    $tanggal = date('Ymd');
	    $kode=$_POST['code'][$x];
	    $jenis_locotrack=$_POST['jenis'][$x];
	    $kondisi=$_POST['cek'][$x];
	    $user=$_COOKIE['nama'];

    	$a=$object->simpanCheckLocotrack($tanggal,$time,$kode,$kondisi,$user);
		...
		<p>Data Check locotrack Berhasil tersimpan!.</p>
		<a href="locotrack.php"><button id="oke_blue">Oke</button></a>
		</div></div>';										
	    }
	    else{
