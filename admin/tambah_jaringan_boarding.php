							...
							<form id="form" class="form-horizontal" method="POST">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Form Penginputan Boarding Jaringan</h2>
										<p class="panel-subtitle">
											Penambahan Boarding yang di perukan di PT KAI DRIVE III
										</p>
									</header>
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" class="form-control" placeholder="eg.: Kode Boarding" required name="kode"/>
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label">Nama Boarding Jaringan :  <span class="required">*</span></label>
											<div class="col-sm-9">
												<input type="text" class="form-control" placeholder="eg.: Nama Boarding " required name="nama"/>
											</div>
											<div class="col-sm-9">
											</div>
										</div>	
					...
					<!-- Memasukkan Boarding ke Database -->
						<?php 
							if(isset($_POST["submit"]))
							{
								...
								$a=$object->simpandatajaringanboarding($kode,$nama_boarding,$lokasi);
	       					...
	       					if($a){
	       						echo '<div id="tampil_modal">
											    <div id="modal_blue">
											      ...
											      <a href="tambah_jaringan_boarding.php"><button id="oke_blue">Oke</button></a>
											    </div></div>';
	       						...
	       						echo '<div id="tampil_modal">
											    <div id="modal">
											      ...
											      <a href="tambah_jaringan_boarding.php"><button id="oke">Oke</button></a>
											    </div></div>';	
	       						}
