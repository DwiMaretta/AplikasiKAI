...
$koneksi=$object->koneksi();
		...
		<form action="laporan_cctv_stasiun.php" method="post" name="postform">
			<p align="center"><font color="orange" size="5"><b>Laporan Kondisi CCTV Stasiun</b></font></p><br />
		...
		<?php
			...
			<script language="JavaScript">
				...
				document.location='laporan_cctv_stasiun.php';
			</script>
			<?php
			}else{
			...
			<?php
			$query=mysqli_query($koneksi,"SELECT * from kondisi_cctv_stasiun INNER JOIN cctv_stasiun ON cctv_stasiun.kode = kondisi_cctv_stasiun.kode_cctv where `nama_stasiun`='$nama_stasiun' and tanggal between '$tanggal_awal' and '$tanggal_akhir'");
			}
		?>
		<br>
		<a style="margin-bottom:10px" href="excel_cctv_stasiun_oke.php?awal=<?php echo $_POST['tanggal_awal']?>&akhir=<?php echo $_POST['tanggal_akhir']?>&nama=<?php echo $_POST['nama']?>" target="_blank" class="btn btn-default pull-right"><span class='glyphicon glyphicon-print'></span>  Excel</a>
		<a style="margin-bottom:10px" href="pdf_cctv_stasiun_.php?awal=<?php echo $_POST['tanggal_awal']?>&akhir=<?php echo $_POST['tanggal_akhir']?>&nama=<?php echo $_POST['nama']?>" target="_blank" class="btn btn-default pull-right"><span class='glyphicon glyphicon-print'></span>  PDF</a>
		</p>
